...
# -------------------------
# 2. Function to build a library for a specific arch
# -------------------------
build_library () {
    local name=$1
    local url=$2
...
# -------------------------
# 4. Create universal dylibs using lipo
# -------------------------
...
# -------------------------
# 5. Copy headers (from any arch, they’re identical)
# -------------------------
...
# -------------------------
# 7. Create symlinks for macOS framework
# -------------------------
cd "$FRAMEWORK_DIR"
...
echo "✅ Universal FLINT.framework ready at $FRAMEWORK_DIR"
