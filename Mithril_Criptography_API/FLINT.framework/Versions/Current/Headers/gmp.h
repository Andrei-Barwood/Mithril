...
#define __GMP_CC "/Library/Developer/CommandLineTools/usr/bin/clang"
#define __GMP_CFLAGS "-arch arm64 -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=11.0 -O3 -fno-stack-check"
